...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <div class="form-group align-items-start d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            ...
            <a href="#loadMediaModal" data-dropzone="image" data-toggle="modal" data-target="#mediaModal" class="btn btn-outline-secondary btn-sm float-right mt-1">{{ trans('lang.media_select')}}</a>
...
<div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
    ...
    <a href="{!! route('galleries.index') !!}" class="btn btn-default text-white"><i class="fas fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
