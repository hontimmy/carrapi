   ...
   <div class="page-wrapper">
	  <div class="content container-fluid">
		<!-- Page Header -->
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    <h1 class="m-0 text-bold">{{trans('lang.option_plural')}} </h1>
                </div><!-- /.col -->
                <div class="col-md-6">
                    <ol class="breadcrumb bg-white float-sm-right rounded-pill px-4 py-2 d-none d-md-flex">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{!! route('options.index') !!}">{{trans('lang.option_plural')}}</a>
                        </li>
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    @can('options.index')
                        <li class="nav-item">
                            <a class="nav-link" href="{!! route('options.index') !!}"><i class="fas fa-list mr-2"></i>{{trans('lang.option_table')}}</a>
                        </li>
                    @endcan
                    @can('options.create')
                        <li class="nav-item">
                            <a class="nav-link" href="{!! route('options.create') !!}"><i class="fas fa-plus mr-2"></i>{{trans('lang.option_create')}}</a>
                        </li>
                    @endcan
                    <li class="nav-item">
