...
<!-- Page Wrapper -->
		...
		<div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-bold">Backend {{trans('lang.dashboard')}}</h1>
                </div>
                <div class="col-sm-6">
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<p class="text-muted mt-3 mb-0"><span class="text-success mr-1"><i class="fas fa-arrow-up mr-1"></i></span> Total Customers account</p>
								</div>
							</div>
						</div>
							...
							<div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<div class="dash-title">Providers Account</div>
											<div class="dash-counts">
												<p>{{$membersCount}}</p>
											</div>
										</div>
									...
									<p class="text-muted mt-3 mb-0"><span class="text-success mr-1"><i class="fas fa-arrow-up mr-1"></i></span> Total Providers account</p>
								</div>
							</div>
						</div>
										...
										<table class="table table-stripped table-hover">
											...
											<tbody>
													...
													<td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																...
																<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-trash-alt mr-2"></i>Delete</a>
																<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-check-circle mr-2"></i>Mark as sent</a>
																<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-paper-plane mr-2"></i>Send Invoice</a>
																<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-copy mr-2"></i>Clone Invoice</a>
															</div>
														</div>
													</td>
												</tr>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html"><img class="avatar avatar-sm mr-2 avatar-img rounded-circle" src="assets/img/profiles/avatar-10.jpg" alt="User Image">Joseph Collins</a>
														</h2>
													</td>
													<td>$826</td>
													<td>25 Sep 2020</td>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html"><img class="avatar avatar-sm mr-2 avatar-img rounded-circle" src="assets/img/profiles/avatar-11.jpg" alt="User Image">Jennifer Floyd</a>
														</h2>
													</td>
													<td>$519</td>
													<td>18 Sep 2020</td>
										...
										<table class="table table-hover">
											...
											<tbody>
													...
													<td class="text-right">
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																...
																<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-file-alt mr-2"></i>Convert to Invoice</a>
																<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-check-circle mr-2"></i>Mark as sent</a>
																<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-paper-plane mr-2"></i>Send Estimate</a>
																<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-check-circle mr-2"></i>Mark as Accepted</a>
																<a class="dropdown-item" href="javascript:void(0);"><i class="far fa-times-circle mr-2"></i>Mark as Rejected</a>
															</div>
														</div>
													</td>
												</tr>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html"><img class="avatar avatar-sm mr-2 avatar-img rounded-circle" src="assets/img/profiles/avatar-09.jpg" alt="User Image"> Leatha Bailey</a>
														</h2>
													</td>
													<td>30 Sep 2020</td>
													<td>$785</td>
