            ...
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    ...
                    @can('optionGroups.create')
                        <li class="nav-item">
                            <a class="nav-link" href="{!! route('optionGroups.create') !!}"><i class="fas fa-plus mr-2"></i>{{trans('lang.option_group_create')}}
                            </a>
                        </li>
                    @endcan
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}"><i class="fas fa-edit mr-2"></i>{{trans('lang.option_group_edit')}}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
