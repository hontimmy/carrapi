   ...
   <div class="page-wrapper">
	<div class="content container-fluid">
		<!-- Page Header -->
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    <h1 class="m-0 text-bold">{{trans('lang.slide_plural')}} <small class="mx-3">|</small><small>{{trans('lang.slide_desc')}}</small></h1>
                </div><!-- /.col -->
                <div class="col-md-6">
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    @can('slides.index')
                        <li class="nav-item">
                            <a class="nav-link" href="{!! route('slides.index') !!}"><i class="fas fa-list mr-2"></i>{{trans('lang.slide_table')}}</a>
                        </li>
                    @endcan
                    @can('slides.create')
                        <li class="nav-item">
                            <a class="nav-link" href="{!! route('slides.create') !!}"><i class="fas fa-plus mr-2"></i>{{trans('lang.slide_create')}}</a>
                        </li>
                    @endcan
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}"><i class="fas fa-edit mr-2"></i>{{trans('lang.slide_edit')}}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
